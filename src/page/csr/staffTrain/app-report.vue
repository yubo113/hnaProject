...
<script>
	...
	import detailFirst from './staffTrainComponents/staff-detail-1.vue';
	import detailSecond from './staffTrainComponents/staff-detail-2.vue';
	import detailThird from './staffTrainComponents/staff-detail-3.vue';
	import detailFourth from './staffTrainComponents/staff-detail-4.vue';
	import detailFifth from './staffTrainComponents/staff-detail-5.vue';
	import detailSixth from './staffTrainComponents/staff-detail-6.vue';
	import detailSeventh from './staffTrainComponents/staff-detail-7.vue';
	export default {
		...
		methods: {
			...
			getReport: function () {
				...
				this.$post({
					url: '/app/mainReq?reqUrl=/mobile/staffTrain/approvalDetail',
					params: {
			...
			reportOperate: function (resultObj) {
				this.$post({
					url: '/app/mainReq?reqUrl=/stafftraing/hnaResDynamicStafftraing/approvalResult',
					params: {
						'id': this.$route.query.id,
			...
			enterHisReport: function () {
				if (this.readonly) {
					this.$router.replace({name: 'staffTrainHisory', query: this.$route.query});
				} else {
					this.$router.push({name: 'staffTrainHisory', query: this.$route.query});
				}
			},
			//	返回点击结果
