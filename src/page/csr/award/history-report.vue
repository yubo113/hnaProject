<template>
	<div class="csr-work" >
		<div class="app-report bg-white pt-20">
			<div class="mb-20">
    			<span class="text-light-grey span-2 inline tr">奖项名称</span>
    			<span class="span-7 textOverflow inline app-report-text">{{ this.$route.query.actionName }}</span>
    		</div>
    		<div class="mb-20">
...
<script>
	import shortFirst from './awardComponents/award-short-1.vue';
	import shortSecond from './awardComponents/award-short-2.vue';
	import shortThird from './awardComponents/award-short-3.vue';
	import shortFourth from './awardComponents/award-short-4.vue';
	import shortFifth from './awardComponents/award-short-5.vue';
	import shortSixth from './awardComponents/award-short-6.vue';
	import detailFirst from './awardComponents/award-detail-1.vue';
	import detailSecond from './awardComponents/award-detail-2.vue';
	import detailThird from './awardComponents/award-detail-3.vue';
	import detailFourth from './awardComponents/award-detail-4.vue';
	import detailFifth from './awardComponents/award-detail-5.vue';
	import detailSixth from './awardComponents/award-detail-6.vue';
	...
	export default {
		...
		created () {
			console.log(this.$route.query.trainingawardName);
			this.$store.commit('loadingShow');
			this.$store.commit('changeTitle', 'CSR奖项申报历史');
			this.getHisList();
		},
		watch: {
		},
