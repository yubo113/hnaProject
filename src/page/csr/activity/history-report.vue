...
<script>
	import shortFirst from './activityComponents/activity-short-1.vue';
	import shortSecond from './activityComponents/activity-short-2.vue';
	import shortThird from './activityComponents/activity-short-3.vue';
	import shortFourth from './activityComponents/activity-short-4.vue';
	import shortFifth from './activityComponents/activity-short-5.vue';
	import detailFirst from './activityComponents/activity-detail-1.vue';
	import detailSecond from './activityComponents/activity-detail-2.vue';
	import detailThird from './activityComponents/activity-detail-3.vue';
	import detailFourth from './activityComponents/activity-detail-4.vue';
	import detailFifth from './activityComponents/activity-detail-5.vue';
	...
	export default {
		...
		created () {
			...
			this.$store.commit('changeTitle', 'CSR外部活动历史');
			this.getHisList();
		},
		watch: {
		},
