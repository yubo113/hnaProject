		...
		<div>
			...
			<div class="span-7 inline app-report-text vertical-top">
				<div v-if="detail.csrApproval.grantTenderFile && detail.csrApproval.grantTenderFile !== 'null'">
					...
					<span class="text-red pl-10 pr-10" @click="enterFileImg(detail.csrApproval.grantTenderFile)"><i class="fa fa-paperclip" aria-hidden="true"></i></span>
				...
				<div v-if="!short">
					<div v-if="detail.csrApproval.sendNoticeFile && detail.csrApproval.sendNoticeFile !== 'null'">
						...
						<span class="text-red pl-10 pr-10" @click="enterFileImg(detail.csrApproval.sendNoticeFile)"><i class="fa fa-paperclip" aria-hidden="true"></i></span>
