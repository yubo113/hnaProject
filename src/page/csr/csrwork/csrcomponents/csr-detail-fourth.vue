			...
			<div class="span-7 inline app-report-text vertical-top">
				...
				<div v-if="!short">
					...
					<div v-if="detail.csrApproval.submitRoneFile && detail.csrApproval.submitRoneFile !== 'null'">
						...
						<span class="text-red pl-10 pr-10" @click="enterFileImg(detail.csrApproval.submitRoneFile)"><i class="fa fa-paperclip" aria-hidden="true"></i></span>
					...
					<div v-if="detail.csrApproval.oneDiscussFile && detail.csrApproval.oneDiscussFile !== 'null'">
						...
						<span class="text-red pl-10 pr-10" @click="enterFileImg(detail.csrApproval.oneDiscussFile)"><i class="fa fa-paperclip" aria-hidden="true"></i></span>
					...
					<div v-if="detail.csrApproval.collectQuoteFile && detail.csrApproval.collectQuoteFile !== 'null'">
						...
						<span class="text-red pl-10 pr-10" @click="enterFileImg(detail.csrApproval.collectQuoteFile)"><i class="fa fa-paperclip" aria-hidden="true"></i></span>
					...
					<div v-if="detail.csrApproval.designQuotationFile && detail.csrApproval.designQuotationFile !== 'null'">
						...
						<span class="text-red pl-10 pr-10" @click="enterFileImg(detail.csrApproval.designQuotationFile)"><i class="fa fa-paperclip" aria-hidden="true"></i></span>
