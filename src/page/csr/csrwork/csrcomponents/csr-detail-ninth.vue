	    ...
	    <div>
			...
			<div class="span-7 inline app-report-text vertical-top">
    			<div v-if="detail.csrApproval.pressReleaseWrittenFile && detail.csrApproval.pressReleaseWrittenFile !== 'null'">
					...
					<span class="text-red pl-10 pr-10" @click="enterFileImg(detail.csrApproval.pressReleaseWrittenFile)"><i class="fa fa-paperclip" aria-hidden="true"></i></span>
				...
				<div v-if="detail.csrApproval.pressReleaseGrantFile && detail.csrApproval.pressReleaseGrantFile !== 'null'">
					...
					<span class="text-red pl-10 pr-10" @click="enterFileImg(detail.csrApproval.pressReleaseGrantFile)"><i class="fa fa-paperclip" aria-hidden="true"></i></span>
