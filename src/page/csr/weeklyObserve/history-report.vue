	...
	<div class="csr-work" >
		<div class="app-report bg-white pt-20">
			<div class="mb-20">
    			...
    			<span class="span-7 textOverflow inline app-report-text">{{ this.$route.query.projectPen }}</span>
    		</div>
    		<div class="mb-20">
...
<script>
	import shortFirst from './weeklyObserveComponents/weekly-short-1.vue';
	import shortSecond from './weeklyObserveComponents/weekly-short-2.vue';
