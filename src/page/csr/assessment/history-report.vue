	...
	<div class="csr-work" >
		<div class="app-report bg-white pt-20">
			<div class="mb-20">
    			...
    			<span class="span-7 textOverflow inline app-report-text">{{ this.$route.query.proname }}</span>
    		</div>
    		<div class="mb-20">
    			<span class="text-light-grey span-2 inline tr">参与人</span>
    			<span class="span-7 textOverflow inline app-report-text">{{ this.$route.query.participantName }}</span>
    		</div>
		</div>
	    <div class="iscroll">
			<div id="wrapper">
...
<script>
	import shortFirst from './assessmentComponents/assessment-short-1.vue';
	import shortSecond from './assessmentComponents/assessment-short-2.vue';
	import shortThird from './assessmentComponents/assessment-short-3.vue';
	import shortFourth from './assessmentComponents/assessment-short-4.vue';
	import shortFifth from './assessmentComponents/assessment-short-5.vue';
	import shortSixth from './assessmentComponents/assessment-short-6.vue';
	import shortSeventh from './assessmentComponents/assessment-short-7.vue';
	import detailFirst from './assessmentComponents/assessment-detail-1.vue';
	import detailSecond from './assessmentComponents/assessment-detail-2.vue';
	import detailThird from './assessmentComponents/assessment-detail-3.vue';
	import detailFourth from './assessmentComponents/assessment-detail-4.vue';
	import detailFifth from './assessmentComponents/assessment-detail-5.vue';
	import detailSixth from './assessmentComponents/assessment-detail-6.vue';
	import detailSeventh from './assessmentComponents/assessment-detail-7.vue';
	...
	export default {
		...
		created () {
			console.log(this.$route.query.trainingassessmentName);
			this.$store.commit('loadingShow');
			this.$store.commit('changeTitle', '从业人员培训审批');
			this.getHisList();
		},
		watch: {
		},
