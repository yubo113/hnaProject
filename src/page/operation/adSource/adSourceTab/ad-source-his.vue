...
<script>
	...
	export default {
		...
		updated () {
			if (this.adHisIscroll) {
				this.adHisIscroll.refresh();
			}
		},
		mounted () {
			this.initTop('#wrapper', '.iscroll');
			this.adHisIscroll = this.initIscroll('#wrapper');
		},
		beforeDestroy () {
			this.adHisIscroll.destroy();
			this.adHisIscroll = null;
		}
	};
</script>
