<template>
	<div>
		...
		<mediaManageApp v-if="openIndexHead === 0"></mediaManageApp>
		<mediaManageHis v-if="openIndexHead === 1"></mediaManageHis>
	</div>
</template>

<script>
	import mediaManageApp from './mediaManageTab/media-manage-app';
	import mediaManageWApp from './mediaManageTab/media-manage-wapp';
	import mediaManageHis from './mediaManageTab/media-manage-his';
	export default {
		components: { 'mediaManageApp': mediaManageApp, 'mediaManageHis': mediaManageHis, 'mediaManageWApp': mediaManageWApp },
		data () {
			return {
				//	头部tab详细信息
				headerTab: [{
