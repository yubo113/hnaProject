...
<script>
	...
	export default {
		...
		updated () {
			if (this.giftHisIscroll) {
				this.giftHisIscroll.refresh();
			}
		},
		mounted () {
			this.initTop('#wrapper', '.iscroll');
			this.giftHisIscroll = this.initIscroll('#wrapper');
		},
		beforeDestroy () {
			this.giftHisIscroll.destroy();
			this.giftHisIscroll = null;
		}
	};
</script>
