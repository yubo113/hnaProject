<template>
	<div class="layer overflow" v-bind:class="{ 'layerShow': active, 'layerHide': !active }">
		<div class="sider span-8 fl bg-black">
			<div class="siderTitle bg-diffuse pl-50 page-head">
				<div class="inner-center">
					<img class="siderTitleImg inline" src="static/img/csr/diffuse.png" @click="enterIndex"/>
					<span class="text-white inline" @click="enterIndex">传播事务</span>
				</div>
			</div>
			<div class="text-white menuHeight" >
			<div>
				<div class="menuList pl-10" v-for="(group , index) in groupList" :key="index" :class="{'bg-diffuse': openIndex === index}">
	...
	export default {
		data () {
			return {
				...
				groupList: [{
					name: '媒体合作信息库',
					router: '/index/diffuseMessage/mediaInfo',
					content: []
				}, {
					name: '新闻发稿',
					router: '/index/diffuseMessage/newsReleaseList',
					content: []
				}]
			};
		},
