<template>
	<div class="layer overflow" v-bind:class="{ 'layerShow': active, 'layerHide': !active }">
		<div class="sider span-8 fl bg-black">
			<div class="siderTitle bg-progect pl-50 page-head">
				<div class="inner-center">
					<img class="siderTitleImg inline" src="static/img/csr/project.png" @click="enterIndex"/>
					<span class="text-white inline" @click="enterIndex">项目发展</span>
				</div>
			</div>
			<div class="text-white menuHeight" >
			<div>
				<div class="menuList pl-10" v-for="(group , index) in groupList" :key="index" :class="{'bg-progect': openIndex === index}">
	...
	export default {
		data () {
			return {
				...
				{
					name: '公益项目统计工具',
					router: '/index/projectDevelop/projectStatistics',
					content: []
				}, {
					name: '合作伙伴',
					router: '/index/projectDevelop/charitablePartner',
					content: []
				}]
			};
		},
